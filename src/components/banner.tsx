        ...
        <section className='bg-blue-50/40 py-16'>
            <div className='container mx-auto px-4 flex md:flex-row flex-col gap-7 items-center'>
                <div className='md:w-[58%] w-full'>
                    ...
                    <Link href="#" className='text-lg font-semibold text-white flex items-center gap-3 bg-[#34A777] rounded-[10px] rounded-br-[20px] px-9 py-3 w-fit'>
                        Consult now <FaArrowRight />
                    </Link>
                </div>
                <div className='md:w-[42%] w-full'>
                    <Image src="/images/baner-img.png" alt="baner-img" width={114} height={113} className='w-full' />
                </div>
            </div>
        </section>
    )
