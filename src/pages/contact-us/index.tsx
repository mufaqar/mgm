                            ...
                            <ul className=' grid gap-3'>
                                <li>
                                    <Link href="#" className='flex items-center gap-2 text-sm font-normal'>
                                        <FaPhoneAlt className="text-[#89DBC4] border w-7 h-7 p-1.5" /> +92 305 5862457
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#" className='flex items-center gap-2 text-sm font-normal'>
                                        <FaEnvelope className="text-[#89DBC4] border w-7 h-7 p-1.5" /> contact@muslimsguidemalta.com
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#" className='flex items-center gap-2 text-sm font-normal'>
                                        <FaMapPin className="text-[#89DBC4] border w-7 h-7 p-1.5" /> orradino Rd, Paola PLA 9037, Malta
                                    </Link>
                                </li>
                            </ul>
                        </div>
